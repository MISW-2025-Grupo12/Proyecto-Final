...
from modulos.producto.infraestructura.dto import Producto as ProductoModelo
from modulos.producto.infraestructura.dto import TipoProducto as TipoProductoModelo
